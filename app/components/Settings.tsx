...
export default function Settings({ rows, setRows, cols, setCols, anchor, setAnchor, orientation, setOrientation, handleResetGrid, handleExport }: any) {
  return (
